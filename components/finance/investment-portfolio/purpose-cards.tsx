    ...
    <Card className={financePanelClassName + " h-full"}>
      <CardHeader className="flex flex-row items-start justify-between gap-4">
        <div>
          ...
          <CardTitle className="text-xl text-content-strong">Caixinhas patrimoniais</CardTitle>
          <p className="mt-1 max-w-lg text-sm leading-6 text-content">
      ...
      <CardContent className="space-y-3">
        ...
        {dashboard.unclassifiedCents > 0 ? (
          <div className="flex items-center justify-between gap-4 rounded-2xl border border-dashed border-warning/25 bg-warning/[0.06] px-4 py-3">
            <div className="flex min-w-0 items-center gap-3">
              <span className="size-2.5 shrink-0 rounded-full bg-warning" />
              <div className="min-w-0">
                <p className="font-medium text-warning">Não classificado</p>
                <p className="truncate text-xs text-warning/60">
